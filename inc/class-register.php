...
function incom_plugin_activation() {
	...
	$notices[] = $signup . '<br>'.esc_html__( 'Edit your plugin settings: ', 'inline-comments' ).'<strong>
					<a href="options-general.php?page=incom.php">'.esc_html__( 'Inline Comments', 'inline-comments' ).'</a>
					</strong>';
				;
